...
export default function Header() {
  ...
  return (
    <header className="max-w-7xl mx-auto flex justify-between p-5 border border-[#0A7DFF] rounded-full mt-5 ">
      ...
      {/* Mobile Menu */}
      {mobileMenuOpen && (
        <div className="md:hidden absolute  right-12 top-16 p-5 border-b border-[#0A7DFF]">
